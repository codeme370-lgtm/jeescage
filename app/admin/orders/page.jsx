    ...
    return (
        <>
            <div className="flex items-center gap-3 mb-5">
                <h1 className="text-2xl text-slate-500">All <span className="text-slate-800 font-medium">Orders</span></h1>
                {alerts.length > 0 && (
                ...
                {alerts.length > 0 && (
                    <Link href="/admin/address-changes" className="text-xs bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 py-1 rounded-full transition">
                        View All Changes
                    </Link>
                )}
            </div>
