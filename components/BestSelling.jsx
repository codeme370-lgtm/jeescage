...
const BestSelling = () => {
    ...
    return (
        <div className='px-4 my-30 max-w-6xl mx-auto'>
            ...
            <div className={`mt-12 grid gap-3 sm:gap-4 lg:gap-6 ${sidebarOpen ? 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4' : 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5'}`}
